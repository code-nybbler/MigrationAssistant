...
namespace MigrationAssistant
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "MigrationAssistant"),
        ExportMetadata("Description", "Assists the user in the process of mapping legacy SQL database schemas to Microsoft Dataverse tables and columns, as well as exporting mapping documents and SQL queries to be used in migration scripts/packages."),
    ...
    public class MigrationAssistant : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new MigrationAssistantControl();
        }
